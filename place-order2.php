    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Order Feed</a>
            </li>
                <li class="no-padding">
...
<div>
                <div class="card-panel">
                  <div class="row">
                    <form class="formValidate col s12 m12 l6" id="formValidate" method="post" action="routers/order-router2.php" novalidate="novalidate">
                      <div class="row">
...
<?php
	...
	foreach ($_POST as $key => $value)
	{
		...
		if(is_numeric($key)){
		$result = mysqli_query($con, "SELECT * FROM mixedfeed WHERE id = $key");
		while($row = mysqli_fetch_array($result))
		{
			$price = $row['price'];
			$mixedfeed_name = $row['name'];
			$mixedfeed_id = $row['id'];
		}
			$price = $value*$price;
        ...
        <div class="row">
            <div class="col s7">
                <p class="collections-title"><strong>#'.$mixedfeed_id.' </strong>'.$mixedfeed_name.'</p>
            </div>
            <div class="col s2">
    ...
    echo '<li class="collection-item">
        <div class="row">
            ...
            <div class="col s3">
                <span><strong>Kshs. '.$total.'</strong></span>
            </div>
        </div>
    </li>';
