        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li><h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1"><img src="images/logo12.png" alt="logo"></a> <span class="logo-text">Logo</span></h1></li>
                    </ul>
                </div>
            </nav>
        </div>
    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold active"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Feed Menu</a>
            </li>
                <li class="no-padding">
            ...
            <li> <a href="index.php" class="brand-logo darken-1"><img src="images/logo1.png" alt="logo" width="200;"></a></li>					
        </ul>
      ...
      <section id="content">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Quality feed</h5>
              </div>
            </div>
          </div>
        </div>
        ...
        <!--start container-->
        <div class="container">
          <p class="caption">Add, Edit or Remove Feed Items.</p>
          <div class="divider"></div>
          <div class="col s12 m4 l3">
                <h4 class="header">Mixed Animal feed</h4>
              </div>
          <nav id="navigation">
				<!-- responsive-nav -->
		  ...
		  <form class="formValidate" id="formValidate" method="post" action="routers/menu-router3.php" novalidate="novalidate">
            <div class="row">
              <div>
				<table id="data-table-admin" class="responsive-table display" cellspacing="0">
                    <thead>
                      <tr>
                        <th>Name</th>
                        <th>Price/bag</th>
                        <th>Description on how the feed are mixed</th>
                        <th>Available</th>
                      </tr>
                    </thead>
                    ...
                    <tbody>
				<?php
				$result = mysqli_query($con, "SELECT * FROM mixedfeed");
		  ...
		  <form class="formValidate" id="formValidate1" method="post" action="routers/add-animalFeed2.php" novalidate="novalidate">
            <div class="row">
              <div class="col s12 m4 l3">
...
<table>
                    <thead>
                      <tr>
                        ...
                        <th data-field="name">Price/bag</th>
                        <th data-field="description">Description on how the feed are mixed</th>
                      </tr>
                    </thead>
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
      <span>Quality Animal Feeds <a class="grey-text text-lighten-4" href="#" target="_blank">AFODS</a> Lumilu General Traders</span>
        <span class="right"> Design and Developed by <a class="grey-text text-lighten-4" href="#"><b>Pharis Ifedha Lung'ahu</b></a></span>
        </div>
    </div>
  </footer>
    <!-- END FOOTER -->
