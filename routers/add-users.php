...
$sql = "INSERT INTO users (name, username, password, email, address, contact, role, verified, deleted) VALUES ('$name', '$username', '$password', '$email', '$address', $contact, '$role', $verified, $deleted);";
