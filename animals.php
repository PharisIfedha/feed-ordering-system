    ...
    <div class="wrapper">
      ...
      <section id="content">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Feed Menu</h5>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="container">
		  ...
		  <form class="formValidate" id="formValidate" method="post" action="routers/menu-router2.php" novalidate="novalidate">
            <div class="row1">
      ...
      <div class="row">
		  ...
		  <form class="formValidate" id="formValidate1" method="post" action="routers/add-animalFeed.php" novalidate="novalidate">
            <div class="row">
              <div class="col s12 m4 l3">
