    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Feed Menu</a>
            </li>
                <li class="no-padding">
...
<div id="work-collections" class="seaction">
                ...
                <div>
					...
					while($row = mysqli_fetch_array($sql))
					{
                        ...
                        <center><img src="images/logo12.png" alt="logo" width="100"><br></center>
